...
def preprocess_data(df):
    ...
    brand_le.fit_transform(df['Brand'].values)
    fuelcode_le.fit_transform(df['FuelCode'].values)
    date_le.fit_transform(df['PriceUpdatedDate'].values)
...
if __name__ == '__main__':
    ...
    model = joblib.load("prefuel_model.sav")
